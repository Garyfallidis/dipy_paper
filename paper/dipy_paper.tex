...
Dipy is a truly international project where anyone from anywhere in the world
...
possible tracking directions. For example the fODF (fiber orientation distribution function)
...
dramatically after the 0.6 which took place on April 2013 (Fig.~\ref{Fig:gh_stats}),
