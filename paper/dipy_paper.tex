...
the cortex are connected using a modified label map `aparc+aseg.mgz` created by freesurfer{REF} of 89 regions. For a complete example of how we created this figure we recommend reading the online tutorial on the topic from dipy.org/examples_index.html
